...
my %options = ('mapper_ops' => '', 's_scaf_ops' => '');
...
my $sopra_bin = '/home/ishengtsai/bin/SOPRA_v1.4.6/SOPRA_with_prebuilt_contigs' ; 
my $run_script = "run.sh";
my $bowtie = '/nfs/users/nfs_m/mh12/bin/bowtie-0.12.8/bowtie';
my $bowtie2 = '/home/ishengtsai/bin/bowtie2-2.1.0/bowtie2';
my $bwa = '/nfs/users/nfs_m/mh12/bin/bwa-0.6.2/bwa';
