...
#bwa
#my $bwacommand = "/home/ishengtsai/bin/segemehl_0_2_0/segemehl/segemehl.x --threads 32 -d /home/ishengtsai/db/hg19/hg19.fa -i  /home/ishengtsai/db/hg19/hg19.fa.idx -q $input > $output.sam" ; 

#system_call("$bwacommand") ; 

#sam to bam
system_call("java -Xmx6g -jar $picardpath/SortSam.jar VALIDATION_STRINGENCY=LENIENT SORT_ORDER=coordinate INPUT=$output.sam OUTPUT=$output.withoutH.bam CREATE_INDEX=true") ; 
