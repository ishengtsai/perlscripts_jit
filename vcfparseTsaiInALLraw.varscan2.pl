...
#    print "$r[9]\t$r[10]\t$r[11]\n" ; 
    ...
    print "$r[0]\t$r[1]\t" . ($r[1]+$numchar)  . "\t$r[3]\t$r[4]\tcomments: Normal.Father $member1[0] $member1[4] $member1[5] Affected.Mother $member2[0] $member2[4] $member2[5] Affected.son $member3[0] $member3[4] $member3[5] $r[2] $r[5]\n" ;
    $filteredSNP++ ; 
