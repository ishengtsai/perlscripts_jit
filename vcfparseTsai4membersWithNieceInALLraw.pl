...
#	}
 #   }
    ...
    print "$r[0]\t$r[1]\t" . ($r[1]+$numchar)  . "\t$r[3]\t$r[4]\tcomments: Affected.Father $member1[0] $member1[1] Normal.Mother $member2[0] $member2[1] Affected.son $member3[0] $member3[1] Affected.daughter $member4[0] $member4[1] Affected.niece $member8[0] $member8[1] $r[2] $r[5]\n" ;
    $filteredSNP++ ; 
