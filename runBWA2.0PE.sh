...
#echo "/home/ijt/bin/bwa-mem2-2.0pre2_x64-linux/bwa-mem2 index $REF"
#/home/ijt/bin/bwa-mem2-2.0pre2_x64-linux/bwa-mem2 index $REF 


/home/ijt/bin/bwa-mem2-2.0pre2_x64-linux/bwa-mem2 mem  -t $CPU $REF $FORWARD $REVERSE | samtools view -b - > $SAMPLE.bam

#/home/ijt/bin/bwa-mem2-2.0pre2_x64-linux/bwa-mem2 mem -R \'@RG    ID:$SAMPLE    SM:$SAMPLE    LB:$SAMPLE\' -t $CPU $REF $FORWARD $REVERSE | samtools view -b - > $SAMPLE.bam
