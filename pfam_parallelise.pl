...
my $programs = '/home/ishengtsai/bin/PfamScan/pfam_scan.pl -dir /home/ishengtsai/db/Pfam27.0 ' ;
#my $db = ' /home/ishengtsai/db/Pfam27.0  ' ;
...
print QSH "$programs --outfile " . '$SGE_TASK_ID.pfamout  -fasta $SGE_TASK_ID.fa' ; 
...
my $merge_command = "cat *.pfamout > ../$fasta.$PI.pfamscan.out \; " ; 
