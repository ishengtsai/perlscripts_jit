...
#    print "$r[9]\t$r[10]\t$r[11]\n" ; 
    ...
    my @member5 = split /\:/, $r[13] ;
    my @member6= split /\:/, $r[14] ;
    my @member7= split /\:/, $r[15] ;
    ...
    $islowdepth = 1 if $member5[2] eq '.';
    $islowdepth = 1 if $member6[2] eq '.';
    $islowdepth = 1 if $member7[2] eq '.';
    $islowdepth = 1 if $member8[2] eq '.';
    ...
    $islowdepth = 1 if $member5[2] < 15 ;
    $islowdepth = 1 if $member6[2] < 15 ;
    $islowdepth = 1 if $member7[2] < 15 ;
    $islowdepth = 1 if $member8[2] < 15 ;

    #disease parent is member1 $r[9] and member6 $r[14]  
